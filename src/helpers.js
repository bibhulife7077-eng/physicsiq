        ...
        for (const [month, shifts] of Object.entries(months)) {
          for (const [shiftKey, shift] of Object.entries(shifts)) {
            ...
            for (const q of shift.questions) {
              ...
              batch.set(qRef, { id: q.id, type: q.type, topic: q.topic, question: q.question, options: q.options, correct: q.correct, solution: q.solution, subject, year, month, shiftKey })
              total++
            }
          }
        }
